...
class ListsSuite extends FunSuite {
  ...
  test("sum of a few numbers") {
    ...
    assert(sum(List(-4,2,10)) === 8)
    assert(sum(List(0,2,0)) === 2)
    assert(sum(List()) === 0)
  ...
  test("max of a few numbers") {
    ...
    assert(Lists.max(List(5)) === 5)
    assert(Lists.max(List(1,5)) === 5)
    assert(Lists.max(List(1,3,5)) === 5)
    assert(Lists.max(List(5,3,1)) === 5)
    assert(Lists.max(List(1,5,3)) === 5)
    assert(Lists.max(List(5,5,5)) === 5)
    assert(Lists.max(List(5,5,3)) === 5)
    assert(Lists.max(List(3,5,5)) === 5)
    assert(Lists.max(List(3,5,5,1)) === 5)
    assert(Lists.max(List(-10,0,5)) === 5)
    assert(Lists.max(List(-10,0,-5)) === 0)
